...
// CONSTRUCTOR FOR MIDDLE EARTH
/** @brief Computes the creation of Middle Earth.
 *
 * @return Middle Earth.
 * @param xsize The width of Middle Earth.
 * @param ysize The height of Middle Earth.
 * @param num_cities The number of cities in Middle Earth.
 * @param seed The number of seeds dropped.
 * @todo Need to select city names to populate Middle Earth.
 */
...
// DESTRUCTOR FOR MIDDLE EARTH
/** @brief Computes the destruction of Middle Earth.
 *
 * @return The deletion of distance in Middle Earth.
 * @todo Need to delete the distances of Middle Earth.
 */
...
// PRINT FUNCTION FOR MIDDLE EARTH
/** @brief Prints out the information on the created Middle Earth.
 *
 * @return The number of locations to choose from.
 * @todo Need a print statement specifying locations and size.
 */
...
// PRINT TABLE FUNCTION FOR MIDDLE EARTH
/** @brief Prints out a tab-separated table of distances in Middle Earth.
 *
 * @return Table of distances in Middle Earth.
 * @todo Need a print statement specifying location, x-position, and y-position.
 */
...
// GET DISTANCE METHOD FOR MIDDLE EARTH
/** @brief Computes the distance between two cities.
 *
 * @return The distance between two passed cities.
 * @param city1 First city.
 * @param city2 Second city.
 * @todo Need to determine float distances between selected cities.
 */
...
// GET DISTANCE METHOD FOR MIDDLE EARTH
/** @brief Computes a list of cities to travel to.
 *
 * @return A vector list of cities to travel to.
 * @param length The number of cities to travel to.
 * @todo Need to print out a list of cities on the itinerary.
 */
